...
//       <PlayerDropdown innerRef={ref1} handler={handleChange1} profiles={props.profiles} default={{value: "", label: "Need 1"}}/>
//       <PlayerDropdown innerRef={ref2} handler={handleChange2} profiles={props.profiles} default={{value: "", label: "Need 1"}}/>
//       <button
//         type="submit"
...
const NewItem = (props) => {
  ...
  return <NewItemInput defaultText="Enter Player Name" onSubmit={addItem} profiles={props.profiles} default1={{value: "", label: "Need 1"}} default2={{value: "", label: "Need 1"}} />;
};
